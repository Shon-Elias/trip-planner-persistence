...
$(function () {
  ...
  // ~~~~~~~~~~~~~~~~~~~~~~~
    ...
    .then(function(returnedAttractions){
      // console.log('IN HERE: ', returnedAttractions)

      attractionsModule.loadEnhancedAttractions('hotels', returnedAttractions.hotels);
      attractionsModule.loadEnhancedAttractions('restaurants', returnedAttractions.restaurants);
      attractionsModule.loadEnhancedAttractions('activities', returnedAttractions.activities);

      returnedAttractions.hotels.forEach(makeOption, $hotelSelect);
      returnedAttractions.restaurants.forEach(makeOption, $restaurantSelect);
      returnedAttractions.activities.forEach(makeOption, $activitySelect);
    })
